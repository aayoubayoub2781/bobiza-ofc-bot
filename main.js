...
msgRetryCounterMap,
auth: state,
browser: ['BOBIZABOT','Safari','9.7.0'],
...
console.log(chalk.yellow('ㅤ امسح رمز الاستجابة السريعة هذا ، تنتهي صلاحية رمز الاستجابة السريعة في 60 ثانية.'))
}
if (connection == 'open') {
console.log(chalk.yellow('▣──────────────────────────────···\n│\n│❧ تم الاتصال بنجاح في الواتساب تابعني على الواتساب instagram.com/noureddine_ouafy ✅\n│\n▣──────────────────────────────···'))}
if (connection == 'close') {
console.log(chalk.yellow(`🚩ㅤتم إغلاق الاتصال ، يرجى حذف المجلد ${global.authFile} وأعد فحص رمز الاستجابة السريعة QR`))}
}
...
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ الى اللقاء instagram.com/noureddine_ouafy 👋🏻* \n*╚══════════════*'
